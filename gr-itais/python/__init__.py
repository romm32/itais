...
'''
This is the GNU Radio ITAIS module. Place your Python package
...
# import swig generated symbols into the itais namespace
try:
    # this might fail if the module is python-only
    from .itais_swig import *
except module_not_found_error:
    pass

# import any pure python here
from .messages import messages
from .sub_gps import sub_gps
