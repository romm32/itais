...
int main() {
    char crc_result[16];
    char buffer[] = "10000100010010110101011101110000101001000000000000000000000011011100100110111100001101000011100011101110010011111101011110000110101010111010000000000001000011000011111";

    // Call the compute_crc function
    compute_crc(buffer, crc_result, 32);

    // Display the CRC result as individual bits
    std::cout << "CRC Result (binary): ";
    for (int i = 0; i < 16; i++) {
        std::cout << static_cast<int>(crc_result[i]);
    }
    std::cout << std::endl;
