...
class pluto_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.psize = psize = 8972
        self.const = const = 2**15-1
        ...
        self.qtgui_number_sink_0.set_title("complextomag")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.iio_pluto_source_0 = iio.pluto_source('ip:192.168.2.1', 162025000, 750000, 20000000, 32768, True, True, True, 'manual', 20, '', True)
        self.epy_block_0 = epy_block_0.blk(example_param=1.0)
        self._const_range = Range(0, 2**15-1, 1, 2**15-1, 200)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_complex_to_float_0, 0), (self.blocks_nlog10_ff_1, 0))
        ...
        self.connect((self.blocks_nlog10_ff_1, 0), (self.blocks_moving_average_xx_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 11000, 500, firdes.WIN_HAMMING, 6.76))
