...
class transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.zeromq_sub_source_1 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:5001', mss, False, -1)
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:5000', mss, False, -1)
        self.zeromq_pub_sink_1 = zeromq.pub_sink(gr.sizeof_gr_complex, 10, 'tcp://127.0.0.1:6001', mss, False, -1)
        ...
        self.blocks_vector_to_stream_1 = blocks.vector_to_stream(gr.sizeof_gr_complex*10, 1)
        self.blocks_vector_to_stream_0 = blocks.vector_to_stream(gr.sizeof_gr_complex*10, 1)
        self.blocks_stream_to_vector_1 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, 2)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.epy_block_0_0, 2))
        self.connect((self.blocks_stream_to_vector_0, 0), (self.epy_block_0_0, 0))
        self.connect((self.blocks_stream_to_vector_1, 0), (self.epy_block_0_0, 1))
        ...
        self.connect((self.epy_block_0_0, 1), (self.blocks_vector_to_stream_1, 0))
        self.connect((self.epy_block_0_0, 2), (self.epy_block_1, 0))
        self.connect((self.zeromq_sub_source_0, 0), (self.blocks_stream_to_vector_0, 0))
        self.connect((self.zeromq_sub_source_1, 0), (self.blocks_stream_to_vector_1, 0))
