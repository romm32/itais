...
N = 4 #40!!! #Cantidad de muestras correspondiente a 20ms REVISAR CUANTOS TAPS EQUIVALE A 0,5ms.
subintervalos = 0
N_muestras = []
...
umb_y_pow_actual = np.zeros(2) #Se crea este arreglo que es lo que se le pasa al transmisor. Un umbral y una potencia actual en ese orden para que sepa interpretarlo. 
