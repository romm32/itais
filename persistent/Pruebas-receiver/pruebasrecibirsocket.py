...
class pruebasrecibirsocket(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pruebasrecibirsocket")
...
def main(top_block_cls=pruebasrecibirsocket, options=None):
