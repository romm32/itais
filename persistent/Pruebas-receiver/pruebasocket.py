...
class pruebasocket(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "socket")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pruebasocket")
...
def main(top_block_cls=pruebasocket, options=None):
