...
class igualarpotencias(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "eso")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("eso")
        ...
        self.settings = Qt.QSettings("GNU Radio", "igualarpotencias")
        ...
        # Blocks
        ##################################################
        self._amplitud_range = Range(0, 1, 0.05, 0.1, 200)
        ...
        self.qtgui_number_sink_0_0.set_title("nuestro")
        ...
        self.qtgui_number_sink_0.set_title("complextoarg")
        ...
        self.blocks_moving_average_xx_0_0 = blocks.moving_average_ff(1000, 0.001, 4000, 1)
        self.blocks_moving_average_xx_0 = blocks.moving_average_ff(1000, 0.001, 4000, 1)
        self.blocks_complex_to_mag_squared_0 = blocks.complex_to_mag_squared(1)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, amplitud, 0, 0)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_complex_to_mag_squared_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.epy_block_0, 0))
        self.connect((self.blocks_complex_to_float_0, 0), (self.blocks_moving_average_xx_0_0, 0))
...
def main(top_block_cls=igualarpotencias, options=None):
