...
class pruebita(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.zeromq_pub_sink_0_0_0 = zeromq.pub_sink(gr.sizeof_float, 2, 'tcp://127.0.0.1:5611', 1, False, -1)
        self.zeromq_pub_sink_0_0 = zeromq.pub_sink(gr.sizeof_float, 2, 'tcp://127.0.0.1:5610', 1, False, -1)
        self.epy_block_0_0_0_0 = epy_block_0_0_0_0.blk(example_param=1.0)
        self.epy_block_0_0_0 = epy_block_0_0_0.blk(example_param=1.0)
        self.blocks_vector_to_stream_0_0_0 = blocks.vector_to_stream(gr.sizeof_float*2, 1)
        self.blocks_vector_to_stream_0_0 = blocks.vector_to_stream(gr.sizeof_float*2, 1)
